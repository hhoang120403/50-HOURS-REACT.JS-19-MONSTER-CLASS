    ...
    <div className='w-[80%] flex'>
      {images.map((image, index) => (
        ...
        >
          ...
          <motion.div
            className='absolute inset-0 flex items-center justify-center text-white bg-black/50 opacity-0 hover:opacity-100  transition-opacity duration-300 cursor-pointer'
