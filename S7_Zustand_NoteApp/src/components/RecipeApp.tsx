...
import { useStoreRecipe, type Recipe } from '../store/useStore';
      ...
      <div className='bg-white p-6 rounded-lg shadow-lg w-full max-w-2xl'>
        ...
        <div className='space-y-4 mb-6'>
          ...
          <textarea
            ...
            className='w-full px-4 py-2 border rounded-lg border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 resize-none'
          />
